/*
  ...
  - You are about to drop the column `addedNewField` on the `Transaction` table. All the data in the column will be lost.
...
CREATE TABLE "new_Transaction" (
    ...
    "newfield" TEXT NOT NULL DEFAULT 'default value',
